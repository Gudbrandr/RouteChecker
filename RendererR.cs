...
//			// textures
//			string Folder = OpenBveApi.Path.CombineDirectory(RouteChecker.Program.FileSystem.GetDataFolder(), "Routeer");
...
//			}
//			// render
//			if (!RouteChecker.Program.CurrentlyLoading) {
...
//					if (RouteChecker.Program.JumpToPositionEnabled) {
//						DrawString(Fonts.SmallFont, "Jump to track position:", new Point(4, 80),TextAlignment.TopLeft, Color128.White, true);
//						double distance;
//						if (Double.TryParse(RouteChecker.Program.JumpToPositionValue, out distance))
//						{
//							if (distance < RouteChecker.Program.MinimumJumpToPositionValue - 100)
//							{
//								DrawString(Fonts.SmallFont, (Environment.TickCount % 1000 <= 500 ? RouteChecker.Program.JumpToPositionValue + "_" : RouteChecker.Program.JumpToPositionValue), new Point(4, 100), TextAlignment.TopLeft, Color128.Red, true);
//							}
//							else
//							{
//								DrawString(Fonts.SmallFont, (Environment.TickCount % 1000 <= 500 ? RouteChecker.Program.JumpToPositionValue + "_" : RouteChecker.Program.JumpToPositionValue), new Point(4, 100), TextAlignment.TopLeft, distance > TrackManager.CurrentTrack.Elements[TrackManager.CurrentTrack.Elements.Length - 1].StartingTrackPosition + 100
...
//					if (RouteChecker.Program.CurrentStation >= 0) {
//						System.Text.StringBuilder t = new System.Text.StringBuilder();
//						t.Append(Game.Stations[RouteChecker.Program.CurrentStation].Name);
//						if (Game.Stations[RouteChecker.Program.CurrentStation].ArrivalTime >= 0.0) {
//							t.Append(", Arrival: " + GetTime(Game.Stations[RouteChecker.Program.CurrentStation].ArrivalTime));
//						}
//						if (Game.Stations[RouteChecker.Program.CurrentStation].DepartureTime >= 0.0) {
//							t.Append(", Departure: " + GetTime(Game.Stations[RouteChecker.Program.CurrentStation].DepartureTime));
//						}
//						if (Game.Stations[RouteChecker.Program.CurrentStation].OpenLeftDoors & Game.Stations[RouteChecker.Program.CurrentStation].OpenRightDoors) {
//							t.Append(", [L][R]");
//						} else if (Game.Stations[RouteChecker.Program.CurrentStation].OpenLeftDoors) {
//							t.Append(", [L][-]");
//						} else if (Game.Stations[RouteChecker.Program.CurrentStation].OpenRightDoors) {
//							t.Append(", [-][R]");
//						} else {
//							t.Append(", [-][-]");
//						}
//						switch (Game.Stations[RouteChecker.Program.CurrentStation].StopMode) {
...
//								break;
//						}
//						if (Game.Stations[RouteChecker.Program.CurrentStation].StationType == Game.StationType.ChangeEnds) {
//							t.Append(", Change ends");
//						}
//						t.Append(", Ratio=").Append((100.0 * Game.Stations[RouteChecker.Program.CurrentStation].PassengerRatio).ToString("0", Culture)).Append("%");
